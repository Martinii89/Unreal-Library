...
namespace UELib.Core
{
    ...
    public partial class UObject : object, IContainsTable, IBinaryData, IDisposable, IComparable
    {
        ...
        ///     The object's flags.
        /// </summary>
        private ulong _ObjectFlags => ExportTable != null ? ExportTable.ObjectFlags : 0;
        ...
        /// <summary>
        ///     Notifies this object instance to make a copy of this object's data from the Owner.Stream and then start
        ...
        public void BeginDeserializing()
        {
            ...
            catch (Exception e)
            {
                ...
                Log.Debug("Deserialization error!:"
        ...
        {
            return HasObjectFlag(ObjectFlagsLO.Public);
        }
        ...
        public bool IsProtected()
        {
            ...
            return Package.Version < AccessFlagChangeVersion ? !IsPublic() && !IsPrivate() : HasObjectFlag(ObjectFlagsHO.PerObjectLocalized);
        }
        ...
        public bool IsPrivate()
        {
            ...
            return Package.Version < AccessFlagChangeVersion ? HasObjectFlag(ObjectFlagsLO.Private) : !IsPublic() && !HasObjectFlag(ObjectFlagsHO.Final);
        }

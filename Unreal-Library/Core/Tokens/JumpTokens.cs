        ...
        public partial class UByteCodeDecompiler
        {
            ...
            public class JumpToken : Token
            {
                ...
                public override void PostDeserialized()
                {
                    ...
                    {
                        Decompiler._Labels.Add(new ULabelEntry
                        {
                ...
                {
                    var i = Decompiler._TempLabels.FindIndex(p => p.Position == CodeOffset);
                    if (i != -1)
                    {
            ...
            public class JumpIfNotToken : JumpToken
            {
                ...
                public override string Decompile()
                {
                    ...
                    IsLoop = false;
                    for (var i = Decompiler.CurrentTokenIndex + 1; i < Decompiler.DeserializedTokens.Count; ++i)
                    {
                    ...
                    var condition = DecompileNext();
                    var output = /*(IsLoop ? "while" : "if") +*/ "if(" + condition + ")";

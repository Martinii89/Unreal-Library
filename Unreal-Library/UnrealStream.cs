...
namespace UELib
{
    ...
    public class UnrealWriter : BinaryWriter
    {
        ...
        protected virtual uint _Version => _UnrealStream.Version;
    ...
    public class UnrealReader : BinaryReader
    {
        ...
        public string ReadText()
        {
            ...
            var size = (unfixedSize =
                ...
                ? -unfixedSize
                : unfixedSize;
            Debug.Assert(size < 1000000, "Dangerous string size detected! IT'S OVER 9000 THOUSAND!");
    ...
    public class UPackageStream : IUnrealStream
    {
        ...
        /// <inheritdoc />
        public uint Version => Package != null ? Package.Version : 0;
